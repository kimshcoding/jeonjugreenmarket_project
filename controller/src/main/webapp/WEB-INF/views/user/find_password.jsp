...
function duplicate() {
  ...
  $.ajax({
    url: '<%=request.getContextPath()%>/find_user_pass', // 서버로 보낼 URL
        ...
        <div class="row justify-content-center">
            <div class="col-lg-4">
                <div class="checkout__form">
                    <form action="find_passwordOK.do" method="post" id="frm">
                     <!-- 이름입력-->
                      	<div class="text-left find-info-links">
                            <span style="margin-right: 12px;">아이디</span>
                        </div>
                        <div class="mb-3">
	                        <div class="input-field-container">
	                            <input type="text" class="form-control custom-style" name="userid" placeholder="아이디를 입력해주세요" maxlength="20">
